...
class OneBaseTurtle(KnowledgeBot):
    ...
    async def create_plan(self) -> BuildOrder:
        ...
        build_steps_buildings = [
            ...
            Step(None, MorphOrbitals(), skip_until=RequiredUnitReady(
            ...
            Step(None, GridBuilding(UnitTypeId.BUNKER, 1),
                 skip_until=RequiredUnitReady(UnitTypeId.BARRACKS, 1)),
            StepBuildGas(2),
        ...
        build_steps_marines = [
            Step(RequiredUnitReady(UnitTypeId.BARRACKS, 1), ActUnit(
                UnitTypeId.MARINE, UnitTypeId.BARRACKS, 100)),
        ]
