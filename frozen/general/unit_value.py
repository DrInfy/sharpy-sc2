...
from frozen.general.unit_feature import UnitFeature
...
class UnitValue:
    ...
    def __init__(self):
        ...
        self.unit_data = {
            ...
            UnitTypeId.LURKER: UnitData(50, 100, 3, 3, features=[UnitFeature.HitsGround, UnitFeature.Cloak]),
            UnitTypeId.LURKERBURROWED: UnitData(50, 100, 3, 3, features=[UnitFeature.HitsGround, UnitFeature.Cloak]),
            ...
            UnitTypeId.BROODLORDEGG: UnitData(150, 150, 4, 0),
...
real_types: Dict[UnitTypeId, UnitTypeId] = {
    ...
    UnitTypeId.LURKERBURROWED: UnitTypeId.LURKER,
    UnitTypeId.LURKERMPBURROWED: UnitTypeId.LURKER,
    UnitTypeId.LURKERMP: UnitTypeId.LURKER,
