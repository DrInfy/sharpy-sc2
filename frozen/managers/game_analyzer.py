...
from frozen.managers import EnemyArmyPredicter
from frozen.managers.game_states.advantage import at_least_clear_disadvantage, at_least_clear_advantage, \
    at_least_advantage, at_least_small_disadvantage, at_least_small_advantage
from frozen.managers.income_calculator import GAS_MINE_RATE
...
from frozen.managers.game_states import *
