...
from frozen.managers import ManagerBase
from sc2 import UnitTypeId, Result
from sc2.unit import Unit

from frozen.managers.enemy_units_manager import ignored_types
...
class LostUnitsManager(ManagerBase):
    ...
    def calculate_own_lost_resources(self) -> Tuple[int, int]:
        """Calculates lost resources for our own frozen. Returns a tuple with (unit_count, minerals, gas)."""
